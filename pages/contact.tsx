  ...
  return (
    <>
      <Head>
        ...
        <meta name='description' content='Get in touch with Mohit Jakhotra - Software Engineer. Available for freelance projects, collaborations, and full-time opportunities.' />
        <meta name='keywords' content='Mohit Jakhotra contact, Software Engineer hire, Pune developer, freelance developer' />
